...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.FieldOfActivityAnnotations.DeploymentSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeploymentSpecificationItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FieldOfActivityAnnotationsPackage.Literals.DEPLOYMENT_SPECIFICATION__RUNTIME_INSTANCES);
			childrenFeatures.add(FieldOfActivityAnnotationsPackage.Literals.DEPLOYMENT_SPECIFICATION__RUNTIME_INSTANCE_AGGREGATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FieldOfActivityAnnotationsPackage.Literals.DEPLOYMENT_SPECIFICATION__RUNTIME_INSTANCES,
				 FieldOfActivityAnnotationsFactory.eINSTANCE.createRuntimeInstance()));

		newChildDescriptors.add
			(createChildParameter
				(FieldOfActivityAnnotationsPackage.Literals.DEPLOYMENT_SPECIFICATION__RUNTIME_INSTANCE_AGGREGATIONS,
				 FieldOfActivityAnnotationsFactory.eINSTANCE.createRuntimeInstanceAggregation()));
	}
