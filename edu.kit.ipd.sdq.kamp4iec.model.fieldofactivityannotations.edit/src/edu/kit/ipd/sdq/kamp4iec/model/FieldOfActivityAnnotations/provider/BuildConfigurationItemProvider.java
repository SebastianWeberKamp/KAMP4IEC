...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.FieldOfActivityAnnotations.BuildConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BuildConfigurationItemProvider extends FileItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BuildConfiguration_component_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BuildConfiguration_component_feature", "_UI_BuildConfiguration_type"),
				 FieldOfActivityAnnotationsPackage.Literals.BUILD_CONFIGURATION__COMPONENT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((BuildConfiguration)object).getFilename();
