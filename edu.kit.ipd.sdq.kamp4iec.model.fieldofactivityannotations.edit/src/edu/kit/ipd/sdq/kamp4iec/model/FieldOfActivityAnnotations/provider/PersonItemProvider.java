...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.FieldOfActivityAnnotations.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FieldOfActivityAnnotationsPackage.Literals.PERSON__ROLES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FieldOfActivityAnnotationsPackage.Literals.PERSON__NAME,
				 true,
				 false,
				 false,
