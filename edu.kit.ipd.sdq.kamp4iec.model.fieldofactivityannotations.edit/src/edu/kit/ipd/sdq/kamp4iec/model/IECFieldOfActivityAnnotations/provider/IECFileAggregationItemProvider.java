...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.IECFieldOfActivityAnnotations.IECFileAggregation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IECFileAggregationItemProvider 
	 ...
	 * @generated
	 */
	public IECFileAggregationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IECFileAggregation_numberOfFiles_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IECFileAggregation_numberOfFiles_feature", "_UI_IECFileAggregation_type"),
				 IECFieldOfActivityAnnotationsPackage.Literals.IEC_FILE_AGGREGATION__NUMBER_OF_FILES,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		IECFileAggregation iecFileAggregation = (IECFileAggregation)object;
		return getString("_UI_IECFileAggregation_type") + " " + iecFileAggregation.getNumberOfFiles();
	}
