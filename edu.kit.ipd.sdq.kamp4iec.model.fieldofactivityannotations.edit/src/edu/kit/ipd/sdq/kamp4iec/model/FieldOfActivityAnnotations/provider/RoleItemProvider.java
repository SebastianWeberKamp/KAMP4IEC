...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.FieldOfActivityAnnotations.Role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_person_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_person_feature", "_UI_Role_type"),
				 FieldOfActivityAnnotationsPackage.Literals.ROLE__PERSON,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FieldOfActivityAnnotationsPackage.Literals.ROLE__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_components_feature", "_UI_Role_type"),
				 FieldOfActivityAnnotationsPackage.Literals.ROLE__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Role)object).getDescription();
