...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.FieldOfActivityAnnotations.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FieldOfActivityAnnotationsPackage.Literals.FILE__FILENAME,
				 true,
				 false,
				 false,
	...
	protected void addTechnologyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_File_technology_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_File_technology_feature", "_UI_File_type"),
				 FieldOfActivityAnnotationsPackage.Literals.FILE__TECHNOLOGY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((File)object).getFilename();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(File.class)) {
			case FieldOfActivityAnnotationsPackage.FILE__FILENAME:
			case FieldOfActivityAnnotationsPackage.FILE__TECHNOLOGY:
