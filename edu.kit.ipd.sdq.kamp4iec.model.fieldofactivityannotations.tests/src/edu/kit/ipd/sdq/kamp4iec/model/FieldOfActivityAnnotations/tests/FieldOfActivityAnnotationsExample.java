 ...
 * @generated
 */
public class FieldOfActivityAnnotationsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(FieldOfActivityAnnotationsPackage.eNS_URI, 
			 FieldOfActivityAnnotationsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				...
				FieldOfActivityAnnotationsRepository root = FieldOfActivityAnnotationsFactory.eINSTANCE.createFieldOfActivityAnnotationsRepository();
...
} //FieldOfActivityAnnotationsExample
