 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4iec.model.FieldOfActivityAnnotations.impl.SourceFileImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4iec.model.FieldOfActivityAnnotations.impl.SourceFileImpl#getComponent <em>Component</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SourceFileImpl extends FileImpl implements SourceFile {
	/**
	...
	public DevelopmentArtefactSpecification getParent() {
		if (eContainerFeatureID() != FieldOfActivityAnnotationsPackage.SOURCE_FILE__PARENT) return null;
	...
	public NotificationChain basicSetParent(DevelopmentArtefactSpecification newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, FieldOfActivityAnnotationsPackage.SOURCE_FILE__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(DevelopmentArtefactSpecification newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != FieldOfActivityAnnotationsPackage.SOURCE_FILE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, FieldOfActivityAnnotationsPackage.DEVELOPMENT_ARTEFACT_SPECIFICATION__SOURCE_FILES, DevelopmentArtefactSpecification.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldOfActivityAnnotationsPackage.SOURCE_FILE__PARENT, newParent, newParent));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FieldOfActivityAnnotationsPackage.SOURCE_FILE__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case FieldOfActivityAnnotationsPackage.SOURCE_FILE__PARENT:
				return eInternalContainer().eInverseRemove(this, FieldOfActivityAnnotationsPackage.DEVELOPMENT_ARTEFACT_SPECIFICATION__SOURCE_FILES, DevelopmentArtefactSpecification.class, msgs);
		}
