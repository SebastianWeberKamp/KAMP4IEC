 ...
 * </p>
 * <ul>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECUnitTestCaseAggregationImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECUnitTestCaseAggregationImpl#getProvidedrole <em>Providedrole</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IECUnitTestCaseAggregationImpl extends IECTestCaseAggregationImpl implements IECUnitTestCaseAggregation {
		...
		if (providedrole != null && ((EObject)providedrole).eIsProxy()) {
			...
			if (providedrole != oldProvidedrole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IECFieldOfActivityAnnotationsPackage.IEC_UNIT_TEST_CASE_AGGREGATION__PROVIDEDROLE, oldProvidedrole, providedrole));
			}
		}
		return providedrole;
	}
	...
	public void setProvidedrole(OperationProvidedRole newProvidedrole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IECFieldOfActivityAnnotationsPackage.IEC_UNIT_TEST_CASE_AGGREGATION__PROVIDEDROLE, oldProvidedrole, providedrole));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IECFieldOfActivityAnnotationsPackage.IEC_UNIT_TEST_CASE_AGGREGATION__PARENT:
				return getParent();
			case IECFieldOfActivityAnnotationsPackage.IEC_UNIT_TEST_CASE_AGGREGATION__PROVIDEDROLE:
