 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4iec.model.IECFieldOfActivityAnnotations.impl.IECUnitTestCaseImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4iec.model.IECFieldOfActivityAnnotations.impl.IECUnitTestCaseImpl#getComponent <em>Component</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IECUnitTestCaseImpl extends IECTestCaseImpl implements IECUnitTestCase {
		...
		if (component != null && component.eIsProxy()) {
			...
			if (component != oldComponent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IECFieldOfActivityAnnotationsPackage.IEC_UNIT_TEST_CASE__COMPONENT, oldComponent, component));
			}
		}
		return component;
	}
	...
	public void setComponent(IECComponent newComponent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IECFieldOfActivityAnnotationsPackage.IEC_UNIT_TEST_CASE__COMPONENT, oldComponent, component));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IECFieldOfActivityAnnotationsPackage.IEC_UNIT_TEST_CASE__PARENT:
				return getParent();
			case IECFieldOfActivityAnnotationsPackage.IEC_UNIT_TEST_CASE__COMPONENT:
