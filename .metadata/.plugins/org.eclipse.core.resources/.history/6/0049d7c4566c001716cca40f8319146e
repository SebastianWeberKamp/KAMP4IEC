...
public class SubactivityDerivation {
	...
	public void deriveSubactivities(Identifier iecComponent, Activity parentActivity, ArchitectureVersion version) {
	...
	private void deriveSubactivity(GlobalVariable globalVariable, Activity parentActivity, ArchitectureVersion version) {
	...
	private void deriveSubactivity(FunctionBlock globalVariable, Activity parentActivity, ArchitectureVersion version) {
		//TODO
	}
