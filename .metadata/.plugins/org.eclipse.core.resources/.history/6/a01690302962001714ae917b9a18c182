...
import Modifikationmarks.ModifyElement;
...
public class ModifikationmarksPackageImpl extends EPackageImpl implements ModifikationmarksPackage {
	 ...
	 * @see Modifikationmarks.ModifikationmarksPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		EGenericType g2 = createEGenericType(this.getKAMP4IECSeedModifications());
