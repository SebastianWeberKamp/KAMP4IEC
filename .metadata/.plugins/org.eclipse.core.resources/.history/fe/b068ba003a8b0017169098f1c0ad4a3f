 ...
 * </p>
 * <ul>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECFieldOfActivityAnnotationsRepositoryImpl#getDevelopmentArtefactSpecification <em>Development Artefact Specification</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECFieldOfActivityAnnotationsRepositoryImpl#getTestSpecification <em>Test Specification</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECFieldOfActivityAnnotationsRepositoryImpl#getDeploymentSpecification <em>Deployment Specification</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECFieldOfActivityAnnotationsRepositoryImpl#getStaffSpecification <em>Staff Specification</em>}</li>
 * </ul>
 *
 * @generated
 */
