 ...
 * </p>
 * <ul>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECAcceptanceTestCaseAggregationImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECAcceptanceTestCaseAggregationImpl#getProvidedrole <em>Providedrole</em>}</li>
 * </ul>
 *
 * @generated
 */
