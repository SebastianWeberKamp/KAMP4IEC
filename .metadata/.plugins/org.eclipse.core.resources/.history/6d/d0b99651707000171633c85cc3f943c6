...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.IECModificationmarks.IECModifyElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IECModifyElementItemProvider extends AbstractModificationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public IECModifyElementItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns IECModifyElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IECModifyElement"));
	}
