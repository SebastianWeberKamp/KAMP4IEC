...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.IECModel.IECInterface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IECInterfaceItemProvider extends IdentifierItemProvider {
	/**
	 ...
	 * @generated
	 */
	public IECInterfaceItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IECModelPackage.Literals.IEC_INTERFACE__HAS_METHOD);
			childrenFeatures.add(IECModelPackage.Literals.IEC_INTERFACE__HAS_PROPERTY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IECInterface"));
	}
	...
	public String getText(Object object) {
		String label = ((IECInterface)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IECInterface_type") :
			getString("_UI_IECInterface_type") + " " + label;
	}
