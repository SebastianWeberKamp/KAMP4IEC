...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.IECModel.FunctionBlock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionBlock_Type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionBlock_Type_feature", "_UI_FunctionBlock_type"),
				 IECModelPackage.Literals.FUNCTION_BLOCK__TYPE,
				 true,
				 false,
				 true,
				 null,
