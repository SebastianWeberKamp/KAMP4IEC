 ...
 * </p>
 * <ul>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECIntegrationTestCaseImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECIntegrationTestCaseImpl#getProvidedrole <em>Providedrole</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECIntegrationTestCaseImpl#getAssemblyConnector <em>Assembly Connector</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IECIntegrationTestCaseImpl extends IECTestCaseImpl implements IECIntegrationTestCase {
		...
		if (providedrole != null && ((EObject)providedrole).eIsProxy()) {
			...
			if (providedrole != oldProvidedrole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IECFieldOfActivityAnnotationsPackage.IEC_INTEGRATION_TEST_CASE__PROVIDEDROLE, oldProvidedrole, providedrole));
			}
		}
		return providedrole;
	}
	...
	public void setProvidedrole(OperationProvidedRole newProvidedrole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IECFieldOfActivityAnnotationsPackage.IEC_INTEGRATION_TEST_CASE__PROVIDEDROLE, oldProvidedrole, providedrole));
	}
	...
	public AssemblyConnector getAssemblyConnector() {
		if (assemblyConnector != null && ((EObject)assemblyConnector).eIsProxy()) {
			...
			if (assemblyConnector != oldAssemblyConnector) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IECFieldOfActivityAnnotationsPackage.IEC_INTEGRATION_TEST_CASE__ASSEMBLY_CONNECTOR, oldAssemblyConnector, assemblyConnector));
			}
		}
	...
	public void setAssemblyConnector(AssemblyConnector newAssemblyConnector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IECFieldOfActivityAnnotationsPackage.IEC_INTEGRATION_TEST_CASE__ASSEMBLY_CONNECTOR, oldAssemblyConnector, assemblyConnector));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IECFieldOfActivityAnnotationsPackage.IEC_INTEGRATION_TEST_CASE__PARENT:
				return getParent();
			case IECFieldOfActivityAnnotationsPackage.IEC_INTEGRATION_TEST_CASE__PROVIDEDROLE:
				if (resolve) return getProvidedrole();
				return basicGetProvidedrole();
			case IECFieldOfActivityAnnotationsPackage.IEC_INTEGRATION_TEST_CASE__ASSEMBLY_CONNECTOR:
