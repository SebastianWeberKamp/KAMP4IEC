...
import IECFieldOfActivityAnnotations.IECAcceptanceTestCase;
import IECFieldOfActivityAnnotations.IECAcceptanceTestCaseAggregation;
import IECFieldOfActivityAnnotations.IECDeployer;
import IECFieldOfActivityAnnotations.IECDeploymentSpecification;
import IECFieldOfActivityAnnotations.IECDeveloper;
...
import IECFieldOfActivityAnnotations.IECFile;
...
import IECFieldOfActivityAnnotations.IECTestCase;
import IECFieldOfActivityAnnotations.IECTestCaseAggregation;
import IECFieldOfActivityAnnotations.IECTestDeveloper;
...
import IECFieldOfActivityAnnotations.IECUnitTestCaseAggregation;
...
public class IECFieldOfActivityAnnotationsPackageImpl extends EPackageImpl implements IECFieldOfActivityAnnotationsPackage {
	 ...
	 * @generated
	 */
	private EClass iecDeploymentSpecificationEClass = null;
	 ...
	 * @generated
	 */
	private EClass iecRuntimeInstanceEClass = null;
	 ...
	 * @generated
	 */
	private EClass iecRuntimeInstanceAggregationEClass = null;
	 ...
	 * @generated
	 */
	private EClass iecIntegrationTestCaseAggregationEClass = null;
	 ...
	 * @see IECFieldOfActivityAnnotations.IECFieldOfActivityAnnotationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getIECTestSpecification_IntegrationTestCases() {
	...
	public EReference getIECTestSpecification_AcceptanceTestCaseAggregations() {
		return (EReference)iecTestSpecificationEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EClass getIECDeploymentSpecification() {
		return iecDeploymentSpecificationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getIECDeploymentSpecification_RuntimeInstances() {
		return (EReference)iecDeploymentSpecificationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getIECDeploymentSpecification_RuntimeInstanceAggregations() {
		return (EReference)iecDeploymentSpecificationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getIECDeploymentSpecification_Parent() {
		return (EReference)iecDeploymentSpecificationEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getIECRuntimeInstance() {
		return iecRuntimeInstanceEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getIECRuntimeInstance_Parent() {
		return (EReference)iecRuntimeInstanceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getIECRuntimeInstance_Name() {
		return (EAttribute)iecRuntimeInstanceEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getIECRuntimeInstance_Description() {
		return (EAttribute)iecRuntimeInstanceEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getIECRuntimeInstance_Components() {
		return (EReference)iecRuntimeInstanceEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EClass getIECRuntimeInstanceAggregation() {
		return iecRuntimeInstanceAggregationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getIECRuntimeInstanceAggregation_Parent() {
		return (EReference)iecRuntimeInstanceAggregationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getIECRuntimeInstanceAggregation_NumberOfInstances() {
		return (EAttribute)iecRuntimeInstanceAggregationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getIECRuntimeInstanceAggregation_Description() {
		return (EAttribute)iecRuntimeInstanceAggregationEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getIECRuntimeInstanceAggregation_Components() {
		return (EReference)iecRuntimeInstanceAggregationEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getIECUnitTestCase_Providedrole() {
	 ...
	 * @generated
	 */
	public EReference getIECAcceptanceTestCase_Providedrole() {
	 ...
	 * @generated
	 */
	public EReference getIECIntegrationTestCase_Providedrole() {
	 ...
	 * @generated
	 */
	public EReference getIECIntegrationTestCase_AssemblyConnector() {
		return (EReference)iecIntegrationTestCaseEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getIECUnitTestCaseAggregation_Providedrole() {
	 ...
	 * @generated
	 */
	public EReference getIECAcceptanceTestCaseAggregation_Providedrole() {
	 ...
	 * @generated
	 */
	public EClass getIECIntegrationTestCaseAggregation() {
		return iecIntegrationTestCaseAggregationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getIECIntegrationTestCaseAggregation_Parent() {
		return (EReference)iecIntegrationTestCaseAggregationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getIECIntegrationTestCaseAggregation_Providedrole() {
		return (EReference)iecIntegrationTestCaseAggregationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getIECIntegrationTestCaseAggregation_AssemblyConnector() {
		return (EReference)iecIntegrationTestCaseAggregationEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(iecTestSpecificationEClass, IEC_TEST_SPECIFICATION__INTEGRATION_TEST_CASES);
		...
		createEReference(iecDeploymentSpecificationEClass, IEC_DEPLOYMENT_SPECIFICATION__RUNTIME_INSTANCE_AGGREGATIONS);
		createEReference(iecDeploymentSpecificationEClass, IEC_DEPLOYMENT_SPECIFICATION__PARENT);

		iecRuntimeInstanceEClass = createEClass(IEC_RUNTIME_INSTANCE);
		createEReference(iecRuntimeInstanceEClass, IEC_RUNTIME_INSTANCE__PARENT);
		createEAttribute(iecRuntimeInstanceEClass, IEC_RUNTIME_INSTANCE__NAME);
		createEAttribute(iecRuntimeInstanceEClass, IEC_RUNTIME_INSTANCE__DESCRIPTION);
		createEReference(iecRuntimeInstanceEClass, IEC_RUNTIME_INSTANCE__COMPONENTS);

		iecRuntimeInstanceAggregationEClass = createEClass(IEC_RUNTIME_INSTANCE_AGGREGATION);
		createEReference(iecRuntimeInstanceAggregationEClass, IEC_RUNTIME_INSTANCE_AGGREGATION__PARENT);
		createEAttribute(iecRuntimeInstanceAggregationEClass, IEC_RUNTIME_INSTANCE_AGGREGATION__NUMBER_OF_INSTANCES);
		createEAttribute(iecRuntimeInstanceAggregationEClass, IEC_RUNTIME_INSTANCE_AGGREGATION__DESCRIPTION);
		createEReference(iecRuntimeInstanceAggregationEClass, IEC_RUNTIME_INSTANCE_AGGREGATION__COMPONENTS);

		iecUnitTestCaseEClass = createEClass(IEC_UNIT_TEST_CASE);
		createEReference(iecUnitTestCaseEClass, IEC_UNIT_TEST_CASE__PARENT);
		createEReference(iecUnitTestCaseEClass, IEC_UNIT_TEST_CASE__PROVIDEDROLE);
		...
		createEReference(iecAcceptanceTestCaseEClass, IEC_ACCEPTANCE_TEST_CASE__PROVIDEDROLE);
		...
		createEReference(iecIntegrationTestCaseEClass, IEC_INTEGRATION_TEST_CASE__PROVIDEDROLE);
		createEReference(iecIntegrationTestCaseEClass, IEC_INTEGRATION_TEST_CASE__ASSEMBLY_CONNECTOR);
		...
		createEReference(iecUnitTestCaseAggregationEClass, IEC_UNIT_TEST_CASE_AGGREGATION__PROVIDEDROLE);
		...
		createEReference(iecAcceptanceTestCaseAggregationEClass, IEC_ACCEPTANCE_TEST_CASE_AGGREGATION__PROVIDEDROLE);

		iecIntegrationTestCaseAggregationEClass = createEClass(IEC_INTEGRATION_TEST_CASE_AGGREGATION);
		createEReference(iecIntegrationTestCaseAggregationEClass, IEC_INTEGRATION_TEST_CASE_AGGREGATION__PARENT);
		createEReference(iecIntegrationTestCaseAggregationEClass, IEC_INTEGRATION_TEST_CASE_AGGREGATION__PROVIDEDROLE);
		createEReference(iecIntegrationTestCaseAggregationEClass, IEC_INTEGRATION_TEST_CASE_AGGREGATION__ASSEMBLY_CONNECTOR);
	...
	public void initializePackageContents() {
		...
		initEReference(getIECSourceFile_Component(), theRepositoryPackage.getRepositoryComponent(), null, "component", null, 0, 1, IECSourceFile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIECTestSpecification_IntegrationTestCases(), this.getIECIntegrationTestCase(), this.getIECIntegrationTestCase_Parent(), "integrationTestCases", null, 0, -1, IECTestSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIECDeploymentSpecification_RuntimeInstanceAggregations(), this.getIECRuntimeInstanceAggregation(), this.getIECRuntimeInstanceAggregation_Parent(), "runtimeInstanceAggregations", null, 0, -1, IECDeploymentSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIECDeploymentSpecification_Parent(), this.getIECFieldOfActivityAnnotationsRepository(), this.getIECFieldOfActivityAnnotationsRepository_DeploymentSpecification(), "parent", null, 1, 1, IECDeploymentSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(iecRuntimeInstanceEClass, IECRuntimeInstance.class, "IECRuntimeInstance", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getIECRuntimeInstance_Components(), theRepositoryPackage.getRepositoryComponent(), null, "components", null, 0, -1, IECRuntimeInstance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIECRuntimeInstanceAggregation_Components(), theRepositoryPackage.getRepositoryComponent(), null, "components", null, 0, -1, IECRuntimeInstanceAggregation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIECUnitTestCase_Providedrole(), theRepositoryPackage.getOperationProvidedRole(), null, "providedrole", null, 0, 1, IECUnitTestCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIECAcceptanceTestCase_Providedrole(), theRepositoryPackage.getOperationProvidedRole(), null, "providedrole", null, 0, 1, IECAcceptanceTestCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIECIntegrationTestCase_Providedrole(), theRepositoryPackage.getOperationProvidedRole(), null, "providedrole", null, 0, 1, IECIntegrationTestCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIECIntegrationTestCase_AssemblyConnector(), theCompositionPackage.getAssemblyConnector(), null, "assemblyConnector", null, 0, 1, IECIntegrationTestCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIECUnitTestCaseAggregation_Providedrole(), theRepositoryPackage.getOperationProvidedRole(), null, "providedrole", null, 0, 1, IECUnitTestCaseAggregation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIECAcceptanceTestCaseAggregation_Providedrole(), theRepositoryPackage.getOperationProvidedRole(), null, "providedrole", null, 0, 1, IECAcceptanceTestCaseAggregation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIECIntegrationTestCaseAggregation_Providedrole(), theRepositoryPackage.getOperationProvidedRole(), null, "providedrole", null, 0, 1, IECIntegrationTestCaseAggregation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIECIntegrationTestCaseAggregation_AssemblyConnector(), theCompositionPackage.getAssemblyConnector(), null, "assemblyConnector", null, 0, 1, IECIntegrationTestCaseAggregation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIECRole_Components(), theRepositoryPackage.getRepositoryComponent(), null, "components", null, 0, -1, IECRole.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
