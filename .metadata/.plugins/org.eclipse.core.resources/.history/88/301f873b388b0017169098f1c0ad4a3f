 ...
 * </p>
 * <ul>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECRuntimeInstanceAggregationImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECRuntimeInstanceAggregationImpl#getNumberOfInstances <em>Number Of Instances</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECRuntimeInstanceAggregationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECRuntimeInstanceAggregationImpl#getComponents <em>Components</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IECRuntimeInstanceAggregationImpl extends MinimalEObjectImpl.Container implements IECRuntimeInstanceAggregation {
	...
	public EList<RepositoryComponent> getComponents() {
		if (components == null) {
			components = new EObjectResolvingEList<RepositoryComponent>(RepositoryComponent.class, this, IECFieldOfActivityAnnotationsPackage.IEC_RUNTIME_INSTANCE_AGGREGATION__COMPONENTS);
		}
		return components;
	}
