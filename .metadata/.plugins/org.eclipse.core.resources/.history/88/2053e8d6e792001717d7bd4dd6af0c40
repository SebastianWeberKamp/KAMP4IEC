 ...
 *   <li>{@link edu.kit.ipd.sdq.kamp4iec.model.IECModel.Function#getHasDerivedReturnType <em>Has Derived Return Type</em>}</li>
 * </ul>
 *
...
public interface Function extends IECComponent {
	 ...
	 * @see edu.kit.ipd.sdq.kamp4iec.model.IECModel.IECModelPackage#getFunction_HasDerivedReturnType()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.kamp4iec.model.IECModel.Function#getHasDerivedReturnType <em>Has Derived Return Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
