 ...
 * </p>
 * <ul>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECTestSpecificationImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECTestSpecificationImpl#getUnitTestCases <em>Unit Test Cases</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECTestSpecificationImpl#getAcceptanceTestCases <em>Acceptance Test Cases</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECTestSpecificationImpl#getIntegrationTestCases <em>Integration Test Cases</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECTestSpecificationImpl#getUnitTestCaseAggregations <em>Unit Test Case Aggregations</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECTestSpecificationImpl#getAcceptanceTestCaseAggregations <em>Acceptance Test Case Aggregations</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECTestSpecificationImpl#getIntegrationTestCaseAggregations <em>Integration Test Case Aggregations</em>}</li>
 * </ul>
 *
 * @generated
 */
