 ...
 *   <li>{@link edu.kit.ipd.sdq.kamp4iec.model.IECModificationmarks.impl.IECSeedModificationsImpl#getFunctionblockModifications <em>Functionblock Modifications</em>}</li>
 * </ul>
 *
 * @generated
 */
