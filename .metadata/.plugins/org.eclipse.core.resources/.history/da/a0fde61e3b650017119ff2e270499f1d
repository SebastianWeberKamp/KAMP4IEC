...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Modify Element</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see edu.kit.ipd.sdq.kamp4iec.model.Modificationmarks.ModificationmarksPackage#getModifyElement()
 * @model
 * @generated
 */
