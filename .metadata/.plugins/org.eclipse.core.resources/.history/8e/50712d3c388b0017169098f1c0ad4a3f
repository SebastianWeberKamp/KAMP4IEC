 ...
 * </p>
 * <ul>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECRoleImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECRoleImpl#getPerson <em>Person</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECRoleImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link IECFieldOfActivityAnnotations.impl.IECRoleImpl#getComponents <em>Components</em>}</li>
 * </ul>
 *
 * @generated
 */
