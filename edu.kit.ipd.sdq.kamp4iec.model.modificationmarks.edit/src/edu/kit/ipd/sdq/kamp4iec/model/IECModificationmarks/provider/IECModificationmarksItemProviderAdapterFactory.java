 ...
 * @generated
 */
public class IECModificationmarksItemProviderAdapterFactory extends IECModificationmarksAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	/**
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(IECModificationmarksEditPlugin.INSTANCE, IECModificationmarksPackage.eNS_URI);
	...
	/**
	 * This keeps track of the one adapter used for all {@link edu.kit.ipd.sdq.kamp4iec.model.IECModificationmarks.IECModifyElement} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.IECModificationmarks.IECModifyElement}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public static class ModificationmarksChildCreationExtender implements IChildCreationExtender {
		...
		protected static class CreationSwitch extends ModificationmarksSwitch<Object> {
			 ...
			 */
			@Override
			public <S extends AbstractSeedModifications, T extends AbstractChangePropagationStep> Object caseAbstractModificationRepository(AbstractModificationRepository<S, T> object) {
