...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.IECModel.Enum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Enum_Type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Enum_Type_feature", "_UI_Enum_type"),
				 IECModelPackage.Literals.ENUM__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((edu.kit.ipd.sdq.kamp4iec.model.IECModel.Enum)object).getName();
