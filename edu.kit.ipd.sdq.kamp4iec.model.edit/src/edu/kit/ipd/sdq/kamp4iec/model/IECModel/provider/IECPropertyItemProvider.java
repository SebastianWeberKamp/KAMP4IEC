...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.IECModel.IECProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IECModelPackage.Literals.IEC_PROPERTY__USES_ENUM,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IECProperty_Type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IECProperty_Type_feature", "_UI_IECProperty_type"),
				 IECModelPackage.Literals.IEC_PROPERTY__TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IECModelPackage.Literals.IEC_PROPERTY__IMPLEMENTS,
				 true,
				 false,
				 true,
				 null,
