 ...
 * @generated
 */
public class ModifikationmarksSwitch<T1> extends Switch<T1> {
	/**
	 ...
	 * @generated
	 */
	public ModifikationmarksSwitch() {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModifikationmarksPackage.ABSTRACT_KAMP4IEC_MODIFICATION_REPOSITORY: {
			...
			case ModifikationmarksPackage.KAMP4IEC_MODIFICATION_REPOSITORY: {
			...
			case ModifikationmarksPackage.KAMP4IEC_SEED_MODIFICATIONS: {
			...
			case ModifikationmarksPackage.CHANGE_PROPAGATION_DUE_TO_DATA_DEPLOY: {
			...
			case ModifikationmarksPackage.MODIFY_ELEMENT: {
			...
			case ModifikationmarksPackage.MODIFY_GLOBAL_VARIABLE: {
			...
			case ModifikationmarksPackage.MODIFY_FUNCTION_BLOCK: {
