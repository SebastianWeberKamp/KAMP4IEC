...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IEC Abstract Property</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4iec.model.IECModel.impl.IECAbstractPropertyImpl#getUsesEnum <em>Uses Enum</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4iec.model.IECModel.impl.IECAbstractPropertyImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4iec.model.IECModel.impl.IECAbstractPropertyImpl#getImplements <em>Implements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IECAbstractPropertyImpl extends IdentifierImpl implements IECAbstractProperty {
	/**
	 ...
	 * @generated
	 */
	protected IECAbstractPropertyImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IECModelPackage.Literals.IEC_ABSTRACT_PROPERTY;
	}
	...
	public EList<edu.kit.ipd.sdq.kamp4iec.model.IECRepository.Enum> getUsesEnum() {
		if (usesEnum == null) {
			usesEnum = new EObjectResolvingEList<edu.kit.ipd.sdq.kamp4iec.model.IECRepository.Enum>(edu.kit.ipd.sdq.kamp4iec.model.IECRepository.Enum.class, this, IECModelPackage.IEC_ABSTRACT_PROPERTY__USES_ENUM);
		}
		return usesEnum;
	}
	...
	public IECInterface getImplements() {
		if (implements_ != null && implements_.eIsProxy()) {
			...
			if (implements_ != oldImplements) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IECModelPackage.IEC_ABSTRACT_PROPERTY__IMPLEMENTS, oldImplements, implements_));
			}
		}
		return implements_;
	}
	...
	public void setImplements(IECInterface newImplements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IECModelPackage.IEC_ABSTRACT_PROPERTY__IMPLEMENTS, oldImplements, implements_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IECModelPackage.IEC_ABSTRACT_PROPERTY__USES_ENUM:
				return getUsesEnum();
